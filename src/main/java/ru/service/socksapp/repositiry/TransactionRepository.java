...
import ru.service.socksapp.model.Transaction;
import ru.service.socksapp.model.TransactionsType;
import ru.service.socksapp.service.TransactionsFileService;
...
public class TransactionRepository {
    ...
    public void addTransaction(SocksColor socksColor, SocksSize socksSize,int cottonPart, int quantity, TransactionsType transactionsType) {
        idCounter = 1L;
        ...
        transactionList.put(idCounter, new Transaction(socksColor, socksSize, cottonPart, quantity, onlyDate, onlyTime, transactionsType));
