...
import ru.service.socksapp.repositiry.SocksRepository;
import ru.service.socksapp.repositiry.TransactionRepository;
...
public class SocksServiceImpl implements SocksService {
    ...
    @Override
    public boolean addSocks(SocksColor socksColor, SocksSize socksSize, int cottonPart, int quantity) {
