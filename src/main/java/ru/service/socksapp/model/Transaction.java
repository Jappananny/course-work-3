...
public class Transaction {
    ...
    public Transaction(SocksColor socksColor, SocksSize socksSize, int cottonPart, int quantity, String timeCreateTransaction, String dateCreateTransaction, TransactionsType transactionsType) {
