package ru.service.socksapp.controllers;
...
import ru.service.socksapp.service.SocksService;
...
public class SocksController {
    ...
    public ResponseEntity<String> income (@PathVariable ("socksColor") SocksColor socksColor, @PathVariable ("socksSize") SocksSize socksSize, @PathVariable ("cottonPart")int cottonPart, @PathVariable ("quantity")int quantity) {
        {
    ...
    public ResponseEntity<String> findTheMinimumCottonPart(@PathVariable ("socksColor")SocksColor socksColor, @PathVariable ("socksSize")SocksSize socksSize, @PathVariable ("cottonMin")int cottonMin) {
    ...
    @Operation(summary = "Общее количество носков с минимальным содержанием хлопка в товаре")
    public ResponseEntity<String> findTheMaximumCottonPart(@PathVariable ("socksColor")SocksColor socksColor, @PathVariable ("socksSize")SocksSize socksSize, @PathVariable ("cottonMax")int cottonMax) {
    ...
    public ResponseEntity<String> outcome(@PathVariable ("socksColor")SocksColor socksColor, @PathVariable ("socksSize")SocksSize socksSize, @PathVariable ("cottonPart")int cottonPart, @PathVariable ("quantity")int quantity)  {
        {
    ...
    public ResponseEntity<String> cancellation(@PathVariable ("socksColor")SocksColor socksColor, @PathVariable ("socksSize")SocksSize socksSize, @PathVariable ("cottonPart")int cottonPart, @PathVariable ("quantity")int quantity) {
        {
