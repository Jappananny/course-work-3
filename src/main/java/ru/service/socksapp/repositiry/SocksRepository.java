package ru.service.socksapp.repositiry;
...
import ru.service.socksapp.model.Socks;
import ru.service.socksapp.model.SocksColor;
import ru.service.socksapp.model.SocksSize;
import ru.service.socksapp.service.SocksFileService;
...
public class SocksRepository {
    ...
    public boolean delete(SocksColor socksColor, SocksSize socksSize, int cottonPart, int quantity) {
    ...
    public boolean out(SocksColor socksColor, SocksSize socksSize, int cottonPart, int quantity) {
        Long bufferKey = findKey(socksColor, socksSize, cottonPart);
        if (repository.containsKey(bufferKey)) {
    ...
    private boolean checkInputValues(int cottonPart, int quantity) {
        return cottonPart > 0 & cottonPart <= 100 & quantity > 0;
    }

    private boolean checkContainsInputValues(SocksColor socksColor, SocksSize socksSize, int cottonPart) {
    ...
    private Long findKey(SocksColor socksColor, SocksSize socksSize, int cottonPart) {
        Long bufferKey = 1L;
